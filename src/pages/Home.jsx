...
const Home = () => {
    return (
        <>
            <main>
                <div className={`${inner} flex items-center h-[100vh]`}>
                    <div className='w-full'>
                        <h1 className='text-[56px] font-[600] mb-[24px] leading-[1.5] tracking-[-0.4px]'>사람을 연결하고, 신뢰를 키워요</h1>
                        <p className={`${textDescription} text-[#5E6778] mb-[60px]`}>
                            근태 관리에서 인사 기록까지, <br /> 
                ...
                <div className='absolute bottom-[0] right-[0] pr-[50px]'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 882 781" width="882" height="781" class="select-none">
                        <g clip-path="url(#clip0_81_5295)">
                        
                        <path opacity="0.5" d="M689.351 0H192.573C181.644 0 172.783 8.86687 172.783 19.8047V322.113C172.783 333.051 181.644 341.917 192.573 341.917H689.351C700.281 341.917 709.141 333.051 709.141 322.113V19.8047C709.141 8.86687 700.281 0 689.351 0Z" fill="#D6E1F3"/>
                        
                        <rect x="234" y="53" width="286" height="32" rx="16" fill="white" class="animate-[bar_3s_ease-in-out_infinite]"/>

                        <rect x="234" y="111" width="367" height="32" rx="16" fill="white" class="animate-[bar2_3s_ease-in-out_infinite]"/>

                        <rect x="234" y="171" width="286" height="32" rx="16" fill="white" class="animate-[bar3_3s_ease-in-out_infinite]"/>

                        <path d="M149.73 618.245H89.9653V781H149.73V618.245Z" fill="#B4E0F0"/>

                        <path d="M120.298 416.387C138.22 416.387 152.75 401.847 152.75 383.911C152.75 365.975 138.22 351.435 120.298 351.435C102.375 351.435 87.8457 365.975 87.8457 383.911C87.8457 401.847 102.375 416.387 120.298 416.387Z" fill="#E2ECD1"/>
                        
                        <g class="origin-[150px_500px] animate-[arm-wiggle_3s_ease-in-out_infinite]">
                            <path d="M150.959 561.687L202.716 531.783L149.414 439.393L97.6566 469.297L150.959 561.687Z" fill="#E8BFD9"/>
                            <path d="M139.725 472.492L89.9346 439.412L-0.0190395 575.006L49.7714 608.086L139.725 472.492Z" fill="#C1AED4" />
                            <path d="M172.792 480.068L202.674 531.864L294.996 478.523L265.114 426.727L172.792 480.068Z" fill="#E7E3DC"/>
                        </g>
                        <path d="M149.73 439.402H89.9653V602.157H149.73V602.157Z" fill="#E9C6A0"/>
                        ...
                        <path d="M550.959 561.687 L650.716 531.783 L600.414 439.393 L547.6566 469.297 L600.959 561.687Z" transform="rotate(-25, 550, 500) translate(0, 22)" fill="#D5DAEE"/>
                        <g class="origin-[590px_510px] animate-[arm-wiggle_2.5s_ease-in-out_infinite]">
                        ...
                        <g class="origin-[590px_510px] animate-[arm-wiggle_3s_ease-in-out_infinite]">
                        ...
                        <g class="origin-[780px_410px] animate-[arm-wiggle_3s_ease-in-out_infinite]">
